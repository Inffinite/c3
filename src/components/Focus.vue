<template>
  <div class="focus">
    <div class="focus-subtitle">Building the future</div>
    <div class="focus-title"><span class="thin">Our</span> Focus</div>
    <div class="f-list">
      <div class="f-item">
        <img
          class="f-item-img"
      ...
      <div class="f-item">
        ...
        <div class="f-item-subtitle">
          Education regardless of gender and advancement of equality laws.
        </div>
      </div>
    </div>
  </div>
